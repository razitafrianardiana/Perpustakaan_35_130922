...
<html>
    ...
    <body>
        ...
        Kelas :
        <select name="id_kelas" value="<?=$dt_siswa['id_kelas']?>" class="form-control">
        ...
        <input type="submit" name="simpan" value="Ubah Siswa" onclick="return confirm('Apakah anda yakin mengubah data ini?')" class="btn btn-primary">
        </form>
